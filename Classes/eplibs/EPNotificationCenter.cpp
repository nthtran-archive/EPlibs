...
// internal functions
//
bool EPNotificationCenter::observerExisted(SelectorProtocol *target,const char *name)
{
    CCObject* obj = NULL;
...
// observer functions
//
void EPNotificationCenter::addObserver(SelectorProtocol *target, 
...
void EPNotificationCenter::removeObserver(SelectorProtocol *target,const char *name)
{
    CCObject* obj = NULL;
    CCARRAY_FOREACH(m_observers, obj)
    {
...
///
////////////////////////////////////////////////////////////////////////////////
EPNotificationObserver::EPNotificationObserver(SelectorProtocol *target, 
                                               SEL_CallFuncO selector,
                                               const char *name,
                                               CCObject *obj)
{
...
SelectorProtocol *EPNotificationObserver::getTarget()
{
    return m_target;
}
